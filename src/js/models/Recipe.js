...
export default class Recipe{
    ...
    async getRecipe(){
        try{
         const res = await axios(`${proxi}https://www.food2fork.com/api/get?key=${key}&rId=${this.id}`);
        ...
        const newIngredients = this.ingredients.map(el =>{
           ...
           if(unitIndex > -1){
              ...
              objIng = {
               ...
               //there is a number in first position but there is not a unit 
               objIng = {
